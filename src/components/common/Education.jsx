...
function Education() {
  ...
  const animateBaseOnId = (id) => {
    if (eduVisible) {
      if (checkEvenOdd(id))
        return "animate-[fadeRightIn_2s_ease-in-out] visible";
      else return "animate-[fadeLeftIn_2s_ease-in-out] visible";
    } else return "invisible";
  };
  return (
    <div
      ref={parRef}
      className="flex z-20 relative py-28 max-md:block max-md:py-2"
    >
